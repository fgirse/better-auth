...
export default function Example() {
  return (
    <section
      id="section-team"
      className="relative mb-[8vh] top-[5vh] w-[100vw] bg-linear-to-b from-[#0d1117] to-[#1d1e1f] lg:bg-size-[100vw_15vh] lg:bg-center lg:bg-no-repeat"
    >
        ...
        <div className="space-y-5 sm:space-y-1">
          <div className="space-y-3 sm:mx-auto sm:max-w-xl lg:max-w-5xl">
            ...
            <div className="flex flex-col items-center justify-center">
              <Image src={LogoAlt} width="200" height="20" alt="LogoAlt" />
            </div>
          </div>

          <p className="font-sans text-xl text-gray-100">Unser Team stellt sich vor</p>
        </div>
        <ul
          role="list"
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="space-y-1 rounded-2xl p-1 text-3xl text-blue-100 font-black leading-6 lg:lg:bg-black/10">
                    <h3 className="font-sans">{person.name}</h3>
                    <p className="font-sans text-yellow-600">{person.role}</p>
                  </div>
