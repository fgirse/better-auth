   ...
   return (
      <footer className="border-t py-6 md:py-0">
         <div className="mt-5 flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="text-centertext-[2rem] md:text-[5rem] lg:text-[12rem] headingA select-none pointer-events-none leading-none bg-gradient-to-br from-yellow-700/100 to-yellow-500/100 bg-clip-text text-transparent opacity-70 tracking-tighter">
               RETTUNGSANKER
            </div>
            <Image
